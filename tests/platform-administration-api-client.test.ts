...
const member = { id: 'user 一', username: 'alice', roles: ['member'], createdAt: '2026-07-30T00:00:00.000Z' }
...
describe('platform administration API client', () => {
  ...
  it('uses the three frozen same-origin routes with exact query and bodies', async () => {
