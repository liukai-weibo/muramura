...
const expectedRouteTable = [
  ...
  'DELETE /api/v1/home-ai-cards/:cardId',
  ...
  'GET /api/v1/backup',
  'GET /api/v1/daily-diet',
  'GET /api/v1/daily-diet/:entryDate',
  'GET /api/v1/daily-notes',
  'GET /api/v1/daily-notes/:id/ai/chat',
  'GET /api/v1/daily-notes/today',
  'GET /api/v1/daily-summaries',
  'GET /api/v1/daily-summaries/:entryDate',
  'GET /api/v1/dashboard',
  'GET /api/v1/experimental/ai-config-status',
'GET /api/v1/experimental/ai-conversation',
  ...
  'GET /api/v1/exploration-tracks/archived',
'GET /api/v1/exploration-tracks/deleted',
  'GET /api/v1/exploration-tracks/selectable',
  'GET /api/v1/home-ai-cards',
  'GET /api/v1/home-ai-cards/caches',
  'GET /api/v1/items',
  'GET /api/v1/items/:id',
  ...
  'PATCH /api/v1/exploration-tracks/:id/description',
  ...
  'POST /api/v1/daily-notes/:id/ai/chat/stream',
  'POST /api/v1/daily-notes/:id/ai/stream',
  'POST /api/v1/daily-notes/:id/ai/todos',
  'POST /api/v1/daily-notes/today',
  'POST /api/v1/daily-notes/today/append',
  'POST /api/v1/experimental/ai-chat/stream',
'POST /api/v1/experimental/ai-chat/stream-ephemeral',
  ...
  'POST /api/v1/exploration-tracks/:id/archive',
'POST /api/v1/exploration-tracks/:id/restore',
'POST /api/v1/exploration-tracks/:id/unarchive',
  'POST /api/v1/home-ai-cards',
  'POST /api/v1/items',
  ...
  'PUT /api/v1/daily-diet/:entryDate',
  'PUT /api/v1/daily-notes/:id',
  'PUT /api/v1/daily-summaries/:entryDate',
  'PUT /api/v1/home-ai-cards/:cardId',
