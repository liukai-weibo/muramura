...
export const AI_BUSINESS_SEMANTICS = [
  'Status meaning: doing means 已开始; idea_to_try means 想尝试; idea_later means 以后考虑; paused means 已暂停.',
  'Status meaning: reviewed means 已复盘; abandoned means 已放弃状态. The recycle bin means deleted or soft-deleted records only.',
