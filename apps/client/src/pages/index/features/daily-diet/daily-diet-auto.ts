...
const DIET_PROMPT = [
  '请你作为我的饮食营养师，先分析我最近 7 天（含今天）的饮食、手记与情绪记录，再给出 1-2 条只针对饮食的建议：',
  '- 具体到食物、怎么吃、补水或饮食节奏，可提示避免什么',
  '- 温和、可执行、不编造，不延伸讨论作息、行动或整体心情',
  '- 若记录很少，就基于已有的给出小心建议，不要编造硬数据',
  '总字数控制在 150 字以内，用换行分段。',
].join('\n')
