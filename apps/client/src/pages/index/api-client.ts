...
export const apiClient = {
  ...
  getDietProfile: (signal?: AbortSignal) => request<DietProfile | null>(`/daily-diet/profile`, { signal }),
  upsertDietProfile: (input: DietProfileInput) => request<DietProfile>(`/daily-diet/profile`, { method: 'PUT', body: json(input) }),
