...
function MobileItems() {
  ...
  return <View className='mobile-items'>
    <View className='mobile-section-heading'><View><Text className='mobile-section-title'>事项</Text><Text className='mobile-section-meta'>{visible.length} 条</Text></View></View>
